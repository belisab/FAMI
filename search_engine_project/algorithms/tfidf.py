...
class TfIdfSearchEngine:
    def __init__(self, documents: Sequence[SearchableDocument]):
    ...
    def search_tfidf(self, query: str, top_k: int = 5) -> List[SearchableDocument]:
        ...
        return [
            self.documents[i]
            for hits, i in ranked_hits_and_doc_ids[:top_k]
        ]
